    ...
    <div style={{ padding: '40px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
        {[
          ...
          { icon: '🕸️', title: 'Fraud Network Graph', desc: 'Graph AI that maps connections between scammer accounts, mule networks and victims into actionable intelligence.', status: 'COMING SOON' },
